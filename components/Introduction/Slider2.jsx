...
export default function Slider2({ id, windowWidth, totalSlides, onChangeSlide }) {
	...
	return (
		<View style={{ flex: 1, width: windowWidth }}>
			<View style={styles.introductionTop}>
				<LottieView
					source={require('../../assets/animations/slider_2_animation.json')}
					autoPlay
					loop
				/>
			</View>
			<View style={styles.introductionBottom}>
				<Text style={styles.sliderTitle}>
					Zaoszczędź swój czas poprzez wygodne i szybkie planowanie
				</Text>
				<Text style={styles.sliderSubTitle}>
					Fizjo planer oferuje wygodny system zarządzania pacjentami i jego wizytami. Dzięki niemu
					nie zapomnisz o żadnej wizycie.
				</Text>
