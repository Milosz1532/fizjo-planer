	...
	useEffect(() => {
		if (confirmCode.length === 6) {
			...
			Dialog.show({
				...
				title: 'Success',
				textBody: 'Kod PIN został pomyślnie zmieniony',
				button: 'OK',
				onPressButton: () => {
					Dialog.hide()
					goBack()
	...
	return (
		<View style={{ flex: 1, backgroundColor: COLORS.primary }}>
			<SafeAreaView
				...
				<View style={[globalStyles.topHeader, { marginTop: 30 }]}>
					<Text
						style={[
							globalStyles.topHeaderTextDark,
							{ marginTop: 5, color: COLORS.main_text_light_color },
						]}>
						Zmiana kodu PIN
					</Text>
				...
				<Animated.View style={[styles.container, animatedStyle]}>
					...
					<Text style={styles.titleText}>{pinEntered ? 'Nowy kod PIN' : 'Aktualny kod PIN'}</Text>
